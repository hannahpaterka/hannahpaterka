...
def card(project: dict, x: int, card_h: int) -> str:
    ...
    return "\n  ".join([
        ...
        f'font-size="7.5" letter-spacing="0.06em">TECH</text>',
        f'<text x="{inner + 36}" y="{stack_y}" fill="#475569" font-family="ui-monospace, Menlo, monospace" font-size="7.5">'
